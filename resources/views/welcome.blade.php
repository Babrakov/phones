...
{{--                            <a href="{{ route('backpack.auth.register') }}" class="ml-4 text-sm text-gray-700 underline">Register</a>--}}
{{--                        @endif--}}
{{--                    @endauth--}}
                    @endif
                </div>
...
{{--                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">База</a></div>--}}
{{--                            </div>--}}
...
{{--                                Sponsor--}}
{{--                            </a>--}}
                            Made by <a href="https://ber-lo.ga" class="ml-1 underline">
                                b3rz3rk
                            </a>
                        </div>
                    </div>
